...
Early development, built screen by screen. Live on Supabase so far: **Screen 1 (Player Performance Profile)** — [`docs/screen-1-report.md`](docs/screen-1-report.md), **Screen 2 (Session/Match Evaluation)** — [`docs/screen-2-report.md`](docs/screen-2-report.md), and **Screen 3 (Match Lineup Builder)** — [`docs/screen-3-report.md`](docs/screen-3-report.md). Scope and acceptance criteria are tracked in the project's Functional Requirements Document (FRD v1.0).
